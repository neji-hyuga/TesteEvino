package com.digitalhouse.testeevino.modules.login.view;
...
import com.digitalhouse.testeevino.modules.noticia.view.NoticiaActivity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void logar() {
        ...
        if (emailDigitado.equals("teste@evino.com") && senhaDigitada.equals("123456")) {
